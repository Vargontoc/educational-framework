package es.vargontoc.educational.framework.agents.infrastructure.service;
...
import es.vargontoc.educational.framework.agents.application.ports.in.CheckStatusModelsUseCase;
import es.vargontoc.educational.framework.agents.application.ports.in.SendMessageChatbotUseCase;
...
import es.vargontoc.educational.framework.agents.domain.AgentStatusType;
