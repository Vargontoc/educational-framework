...
public enum SessionEventType {
    ...
    CHILD_NPC_VOICE_ACTIVATED("NPC voice service is activated for the child."),
    CHILD_NPC_VOICE_DEACTIVATED("NPC voice service is deactivated for the child."),
    CHILD_NPC_ACTIVATED("NPC is activated for the child."),
    CHILD_NPC_DEACTIVATED("NPC is deactivated for the child."),
    CHILD_NPC_VOICE_VOLUME_CHANGED("NPC voice volume changed for the child."),
