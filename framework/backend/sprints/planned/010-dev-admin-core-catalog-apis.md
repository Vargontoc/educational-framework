...
### Persistence
- [ ] Create JPA entities for `Category`, `Topic`, `Activity`, `DifficultyLevel`, and `ActivityResource` if not already created.
- [ ] Create Spring Data repositories for the core catalog entities.
- [ ] Create persistence adapters implementing the content output ports.
- [ ] Add static mapper methods following the existing backend adapter style.

### Application Services
- [ ] Implement use cases for category create, update, get, and list.
- [ ] Implement use cases for topic create, update, get, and list.
- [ ] Implement use cases for activity create, update, get, and list.
- [ ] Implement use cases for difficulty level create, update, get, and list by activity.
- [ ] Implement use cases for activity resource create, update, get, and list by activity.
