...
- [ ] Preserve the preparing/ready state transition behavior.
- [ ] Do not introduce new backend data requirements.

### Minimal Replacement State
- [ ] Render a simple empty World Map base after preparation.
- [ ] Keep current sky/grass child visual register.
