...
## Agent Instruction
- Archived to start Sprint 011 for Parent Control Shell.
...
incomplete_tasks:
- Sprint archived before checklist completion to prioritize `FEAT-005-Parent-Control-View`.
...
- Re-open child creation modal as a later sprint if still required.
