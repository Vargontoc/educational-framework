  ...
  panel: {
    ...
    children: {
      ...
      editModal: {
        ...
        colorVisionLabel: 'Accesibilidad visual',
        colorVisionHelper: 'Este ajuste no sustituye una valoración oftalmológica.',
        colorVisionNotSure: 'No estoy seguro',
        colorVisionNotSureHint: 'Es el ajuste más común, reversible y no es un diagnóstico.',
        colorVisionNoneLabel: 'Sin ajuste visual',
        colorVisionNoneSubtitle: 'Valor por defecto',
        colorVisionProtanopiaLabel: 'Dificultad con rojo, tipo protan',
        colorVisionProtanopiaSubtitle: 'Protanopia',
        colorVisionDeuteranomalyLabel: 'Dificultad con rojo y verde, intensidad habitual',
        colorVisionDeuteranomalySubtitle: 'Deuteranomalía',
        colorVisionDeuteranopiaLabel: 'Dificultad con rojo y verde, tipo deutan',
        colorVisionDeuteranopiaSubtitle: 'Deuteranopía',
